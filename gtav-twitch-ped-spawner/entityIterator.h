...
// Thanks to chaos mod for yoinking it from menyoo mod ¯\_(ツ)_/¯
	...
	public:
		...
		Entity operator*()
		{
			static int(*_addEntityToPoolFunc)(__int64) = []
				{
					Memory::Handle handle = Memory::FindPattern("48 F7 F9 49 8B 48 08 48 63 D0 C1 E0 08 0F B6 1C 11 03 D8").Addr();

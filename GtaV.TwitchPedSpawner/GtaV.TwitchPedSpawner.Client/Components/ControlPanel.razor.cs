namespace GtaV.TwitchPedSpawner.Client.Components;

using GtaV.TwitchPedSpawner.Client.Data;
using GtaV.TwitchPedSpawner.Client.Pages;
...
public partial class ControlPanel : ComponentBase
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        try
        {
            ...
            {
                using var response = await http.GetAsync("http://127.0.0.1:41076/getjwt");
    ...
    {
        using var http = new HttpClient();
        using var response = await http.GetAsync("http://127.0.0.1:41076/kick/" + handle);
    ...
    {
        using var http = new HttpClient();
        using var response = await http.GetAsync("http://127.0.0.1:41076/kickall");
        await Task.Delay(500);
        Parent.Sync();
    }
    ...
    {
        using var http = new HttpClient();
        using var response = await http.GetAsync("http://127.0.0.1:41076/disconnect");
        await Task.Delay(500);
        Parent.Sync();
    }
    ...
    {
        using var http = new HttpClient();
        using var response = await http.GetAsync("http://127.0.0.1:41076/tryreconnect");
        await Task.Delay(500);
        Parent.Sync();
    }
    ...
    {
        using var http = new HttpClient();
        using var response = await http.GetAsync("http://127.0.0.1:41076/logout");
        await Task.Delay(500);
        Parent.Sync();
    }
}
